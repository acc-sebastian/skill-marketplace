...
<header>
  <div class="header-inner">
    ...
    <nav>
      ...
      <a href="https://github.com/accilium/skill-marketplace" target="_blank">GitHub ↗</a>
    </nav>
  </div>
</header>
...
<section class="contribute-section" id="contribute">
  <div class="contribute-inner">
    ...
    <a class="cta-btn" href="https://github.com/accilium/skill-marketplace/blob/main/CONTRIBUTING.md" target="_blank">
...
<footer>
  Built with ♥ by accilium &mdash; <a href="https://github.com/accilium/skill-marketplace" style="color:inherit">GitHub</a>
